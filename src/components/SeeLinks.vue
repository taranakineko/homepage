        ...
        <mdui-card variant="elevated" class="link-left">
            ...
            <div class="me-body">
                ...
                <div class="links-chip">
                    <mdui-chip href="https://alive.bar/@TaranakiNeko"
                        ><mdui-icon slot="icon"
                        ...
                        >Mastodon</mdui-chip
                    >
                    <mdui-chip href="https://twitter.com/taranakineko"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>Twitter</title>
                                <path
                        ...
                        >Twitter</mdui-chip
                    >
                    <mdui-chip href="https://t.me/taranaki_neko"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >Telegram</mdui-chip
                    >
                    <mdui-chip href="https://instagram.com/taranakineko"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >Instagram</mdui-chip
                    >
                    <mdui-chip href="https://bsky.app/profile/taranakineko.bsky.social"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>Bluesky</title>
                                <path
                ...
                <div class="links-chip">
                    ...
                    >
                    <mdui-chip href="https://matrix.to/#/@never7ko:matrix.org"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>Matrix</title>
                                <path
                    ...
                    <mdui-chip loading disabled
                        ...
                        >Telegram</mdui-chip
                    >
                    <mdui-chip href="https://line.me/ti/p/5I4CjyDmEa"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>LINE</title>
                                <path
                ...
                <h3>On Github</h3>
                <div class="links-chip">
                    <mdui-chip href="https://github.com/taranakineko"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
                                <path
                        ...
                        >Github</mdui-chip
                    >
                    <mdui-chip href="https://github.com/users/taranakineko/projects/1"
                        ><mdui-icon slot="icon"
                            ><svg
                                aria-hidden="true"
                                height="16"
                        ...
                        >Project</mdui-chip
                    >
                    <mdui-chip href="https://github.com/taranakineko/homepage"
                        ><mdui-icon slot="icon"
                            ><svg
                                aria-hidden="true"
                                height="16"
                ...
                <h3>其他链接</h3>
                <div class="links-chip">
                    <mdui-chip href="https://bookmarks.nekoq.top/"
                ...
                <h3>Blog</h3>
                <div class="links-chip">
                    <mdui-chip href="https://blog.nekoq.top"
                        ><mdui-icon slot="icon"
                            ><svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <title>Hexo</title>
                                <path
